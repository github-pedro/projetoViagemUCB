...
class CustomAdapter(val context:Activity, private val id:Array<Int>, private val localDestino:Array<String>, private val dataIda:Array<String>, private val tipoViagem:Array<String>, private val bagagem:Array<String>) : ArrayAdapter<String>(context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val idView = view.findViewById<TextView>(R.id.txtId)
        ...
        idView.text = id[position].toString()
